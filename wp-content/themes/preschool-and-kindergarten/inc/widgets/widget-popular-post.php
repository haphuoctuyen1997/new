                            ...
                            <h3 class="entry-title"><a href="<?php the_permalink(); ?>"><?php the_title();?></a></h3>
                                ...
                                <?php if( $show_date ){ ?>
                                    <span class="posted-on"><a href="<?php the_permalink(); ?>">
                                        <time datetime="<?php printf( __( '%1$s', 'preschool-and-kindergarten' ), get_the_date('F j') ); ?>">
                                        <?php printf( __( '%1$s', 'preschool-and-kindergarten' ), esc_html( get_the_date('F j') ) ); ?></time></a>
                                    </span>
                                <?php } ?>
